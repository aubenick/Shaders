Shader "Custom/PerlinNoise" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			// Dented Metal effect (change normal based on noise)
			o.Albedo = float3(mlerp(_Color.r, _TargetColor.r, nse), mlerp(_Color.g, _TargetColor.g, nse), mlerp(_Color.b, _TargetColor.b, nse));
			o.Normal = normalize(nse + o.Normal);
